...
# alias'
alias discord='ELECTRON_FORCE_DEVICE_SCALE_FACTOR=2 discord --ozone-platform=wayland'
alias code='ELECTRON_FORCE_DEVICE_SCALE_FACTOR=2 codium --ozone-platform=wayland'
